<?php include '../templates/includes/header.php'; ?>
                            <!-- enctype(encryption type): Because, we have a file upload -->
				...
				<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="about" rows="6" class="form-control" name="about" placeholder="Tell us about yourself (Optional)"></textarea>
                                </div>
